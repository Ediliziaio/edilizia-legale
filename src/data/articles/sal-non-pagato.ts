...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il punto debole tipico è la prova: nei contenziosi su sospensioni contestate, la differenza la fa quasi sempre la carta. Un'impresa che ha messo in mora per iscritto, atteso il termine e verbalizzato lo stato del cantiere ha una posizione difendibile; una che ha smontato il ponteggio da un giorno all'altro dopo una telefonata, no. Come si costruiscono quelle prove mentre il cantiere è aperto lo spiega la guida su [come dimostrare i lavori eseguiti](/guide/come-dimostrare-lavori-eseguiti)." },

    { type: "figure", slot: "sal-non-pagato-1", alt: "Cantiere con lavorazioni a metà e materiali accatastati, fermo", caption: "Sospendere è legittimo solo dopo aver seguito la procedura: prima la mora scritta, poi il fermo." },
    ...
    { type: "figure", slot: "sal-non-pagato-2", alt: "PEC di costituzione in mora stampata, con il termine evidenziato", caption: "È il documento che trasforma una sospensione ritorsiva in una sospensione legittima." },
    ...
    { type: "timeline", title: "La sequenza che rende legittima la sospensione", steps: [
      { when: "Giorno 0", label: "SAL maturato e non pagato", detail: "Da qui decorrono gli interessi di mora commerciali." },
      { when: "Entro pochi giorni", label: "PEC di costituzione in mora", detail: "Termine di 15 giorni e avvertimento espresso di sospensione ex art. 1460 c.c." },
      { when: "15 giorni dopo", label: "Comunicazione formale di sospensione", detail: "Con verbale fotografico dello stato del cantiere e inventario dei materiali." },
      { when: "Subito dopo", label: "Offerta di ripresa immediata al pagamento", detail: "Dimostra la buona fede e neutralizza l'accusa di sospensione ritorsiva." },
    ] },
