...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Per questo il verbale di consegna è il documento più importante del fascicolo, più ancora del contratto. Un'impresa che chiude ogni cantiere con un verbale datato e sottoscritto dal committente si costruisce, cantiere dopo cantiere, la difesa migliore contro le contestazioni di comodo. Il quadro completo delle prove di cantiere, dalle foto alle email al cliente, è nella guida su [come dimostrare i lavori eseguiti](/guide/come-dimostrare-lavori-eseguiti)." },
