...
export const meta: ArticleMeta = {
  ...
  excerpt:
    "L'impresa ti ha notificato un decreto ingiuntivo ma i lavori hanno difetti? Hai 40 giorni perentori per opporti: eccezione di inadempimento, riconvenzionale per i danni, sospensione dell'esecuzione.",
  category: "Privati",
  date: "Agosto 2026",
  readTime: "15 min",
...
export const article: Article = {
  ...
  content: [
    ...
    { type: "faq", items: [
      { q: "Quanti giorni ho esattamente per oppormi?", a: "Quaranta giorni dalla notifica del decreto (art. 641 c.p.c.), con la sospensione feriale dal 1° al 31 agosto che allunga il calcolo per i decreti notificati a ridosso dell'estate. Il termine è perentorio: entro quella data l'atto di citazione in opposizione deve essere notificato all'impresa, non semplicemente redatto." },
      { q: "Cosa succede se non faccio nulla?", a: "Il decreto viene dichiarato esecutivo ex art. 647 c.p.c. e diventa definitivo: non potrai più contestare vizi, importi o lavori mancanti. L'impresa potrà iscrivere ipoteca sulla casa e pignorare beni e conti. I rimedi tardivi dell'art. 650 c.p.c. coprono solo notifiche irregolari o casi fortuiti da provare." },
      { q: "Posso non pagare perché i lavori sono fatti male?", a: "Puoi rifiutare il pagamento nella misura della contestazione fondata (art. 1460 c.c.), non trattenere tutto per difetti marginali. Serve una quantificazione tecnica dei vizi e delle opere mancanti, e conta come li hai denunciati: entro 60 giorni dalla scoperta e per iscritto (art. 1667 c.c.), non a voce a giudizio iniziato." },
      { q: "Posso chiedere i danni nello stesso giudizio?", a: "Sì, con la domanda riconvenzionale (art. 36 c.p.c.): costo di eliminazione dei vizi, completamento delle opere, danni conseguenti come infiltrazioni o spese di sistemazione. Il giudice compensa le posizioni e condanna al netto. È il passaggio che trasforma l'opposizione da semplice difesa a strumento per riequilibrare i conti." },
      { q: "Devo pagare intanto che la causa va avanti?", a: "Dipende dall'esecutorietà. Se il decreto è provvisoriamente esecutivo, l'impresa può procedere salvo sospensione ex art. 649 c.p.c., da chiedere subito con documenti seri. Se non lo è, l'opposizione tempestiva blocca l'esecuzione, ma il giudice può concederla in corso di causa (art. 648 c.p.c.) se l'opposizione appare debole." },
      { q: "Quanto costa opporsi?", a: "Le voci principali sono il contributo unificato commisurato al valore del decreto (oltre 500 euro per importi tra 26.000 e 52.000 euro), il compenso del legale e di norma una consulenza tecnica. Vanno confrontate con il beneficio realistico: è il calcolo da fare nei primi giorni, prima di decidere tra opposizione e trattativa." },
      { q: "Conviene sempre opporsi?", a: "No. Conviene quando la contestazione documentata è consistente rispetto all'importo ingiunto o il decreto è viziato. Quando i difetti valgono una frazione modesta del richiesto, spesso è più razionale usare l'opposizione come leva per una transazione: pagamento ridotto e rinuncia reciproca, chiusa prima della scadenza del termine." },
    ] },

    { type: "h2", text: "Il passo successivo", id: "cta" },
    { type: "p", text: "Il termine è perentorio e non si riapre. Se hai ricevuto un decreto ingiuntivo, contattaci lo stesso giorno dalla pagina contatti: verifichiamo la notifica, l'esecutorietà e i numeri della tua contestazione, e ti diciamo se conviene opporsi o trattare. Se il problema nasce da lavori difettosi, leggi anche la guida ai difetti nei lavori di ristrutturazione per capire come si denunciano e quanto valgono; se invece l'impresa ti chiede più di quanto pattuito, la guida al preventivo sforato spiega quando gli extra sono dovuti e quando no." },
