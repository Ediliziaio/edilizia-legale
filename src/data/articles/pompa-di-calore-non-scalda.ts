...
export const article: Article = {
  ...
  content: [
    ...
    { type: "figure", slot: "pompa-di-calore-non-scalda-1", alt: "Unità esterna di pompa di calore installata accanto a una villetta non isolata", caption: "Su un impianto a radiatori in un edificio non isolato la macchina lavora fuori dal suo campo di efficienza." },
    ...
    { type: "figure", slot: "pompa-di-calore-non-scalda-2", alt: "Materiale commerciale con la promessa di risparmio in bolletta", caption: "Se la resa compare in brochure o preventivo diventa un elemento contrattuale, non una semplice aspettativa." },
