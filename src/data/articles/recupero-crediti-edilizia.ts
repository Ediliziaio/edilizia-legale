...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Se il quadro documentale è debole — nessun contratto scritto, contabilità informale — il credito non è perso: l'esecuzione dei lavori si può provare con testimoni, foto, DDT, bonifici parziali ricevuti. Ma la strada del decreto ingiuntivo diventa meno lineare e in alcuni casi conviene il giudizio ordinario o, prima ancora, un accertamento tecnico preventivo che cristallizzi lo stato delle opere. Quanto pesa ciascuna di queste prove è spiegato nella guida su [come dimostrare i lavori eseguiti](/guide/come-dimostrare-lavori-eseguiti)." },
