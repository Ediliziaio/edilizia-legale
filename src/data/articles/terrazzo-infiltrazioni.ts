...
export const meta: ArticleMeta = {
  ...
  title: "Il terrazzo rifatto perde ancora: chi paga tra impresa, condominio e proprietario",
  excerpt:
    "Guaina rifatta da poco e infiltrazioni di nuovo sul soffitto? Prima di dividere le spese con l'art. 1126 c.c. va individuato il responsabile: se il rifacimento è difettoso, paga l'impresa, e la garanzia è di dieci anni.",
  category: "Verticali",
  date: "Agosto 2026",
  readTime: "13 min",
  ...
  keywords: [
    ...
    "guaina rifatta infiltrazioni garanzia",
    "infiltrazioni lastrico solare chi paga",
...
export const article: Article = {
  ...
  content: [
    ...
    { type: "table", headers: ["Chi risponde", "Fondamento", "Termini"], rows: [
      ...
      ["Condòmino con uso esclusivo della terrazza", "Art. 1126 c.c. (quota di un terzo)", "Segue il regime della voce che lo coinvolge"],
      ["Produttore della membrana", "Garanzia convenzionale sul materiale", "Secondo il certificato: copre il prodotto, non la posa"],
    ] },

    { type: "h2", text: "Il danno al proprietario sottostante: a chi può chiedere?", id: "danno-sottostante" },
    { type: "p", text: "Il terzo soggetto, spesso dimenticato, è chi il danno lo subisce: il proprietario dell'appartamento sotto la terrazza. A lui viene quasi sempre detto di aspettare la prossima assemblea; nel frattempo il soffitto peggiora e i termini corrono. Non è tenuto ad aspettare nessuno: può agire direttamente contro il condominio quale custode della copertura (art. 2051 c.c.), contro il condòmino che ha l'uso esclusivo per la sua quota, e contro l'impresa esecutrice se il danno deriva dal rifacimento difettoso — anche cumulando le domande nello stesso giudizio." },
    { type: "p", text: "Le voci risarcibili tipiche: ripristino di intonaci e tinteggiature, danni a mobili e arredi, spese di deumidificazione e, quando l'umidità rende inutilizzabile una stanza, il danno da limitato godimento dell'immobile. La prescrizione della sua azione risarcitoria è di cinque anni (art. 2947 c.c.): conviene interromperla subito con una richiesta scritta, senza aspettare gli esiti delle discussioni assembleari. Ogni voce va fotografata e preventivata mentre il danno è visibile." },

    { type: "h3", text: "I passi, nell'ordine giusto" },
    { type: "ol", items: [
      "Documenta subito la data della scoperta: foto datate del soffitto e segnalazione scritta all'amministratore via PEC o raccomandata",
      "Chiedi all'amministratore i documenti dell'appalto di rifacimento: contratto, capitolato, data di fine lavori, eventuale polizza",
      "Denuncia il difetto all'impresa entro 1 anno dalla scoperta (art. 1669 c.c.), a mezzo PEC, riservando ogni azione",
      "Fai eseguire una verifica tecnica: prova di allagamento o indagine termografica per localizzare il punto di ingresso dell'acqua",
      "Se l'impresa nega o il condominio rinvia, deposita ricorso per accertamento tecnico preventivo ex art. 696-bis c.p.c.",
      "Promuovi l'azione entro 1 anno dalla denuncia; il proprietario danneggiato ha 5 anni ex art. 2947 c.c., ma i danni si provano bene solo se documentati subito",
    ] },

    { type: "figure", slot: "terrazzo-infiltrazioni-2", alt: "Guaina impermeabilizzante con raccordo non risvoltato in corrispondenza della soglia", caption: "I difetti di impermeabilizzazione di una copertura rientrano tra i gravi difetti decennali." },

    { type: "h2", text: "Un esempio concreto", id: "esempio" },
    { type: "p", text: "Terrazza a livello di proprietà esclusiva, che funge da copertura per l'appartamento sottostante. Il condominio ne delibera il rifacimento nel 2022 per 34.000 euro. Nell'inverno 2025 il proprietario sottostante lamenta di nuovo macchie di umidità sul soffitto: il ripristino di intonaco e tinteggiatura viene preventivato in 3.850 euro, oltre al danno di una camera resa inutilizzabile nei mesi umidi. In assemblea si discute subito di riparto: un terzo all'usuaria della terrazza, due terzi agli altri. È il primo errore, perché mette insieme le due domande." },
    ...
    { type: "p", text: "Il proprietario sottostante, intanto, non deve attendere l'assemblea: agisce direttamente, verso il condominio come custode e verso l'impresa come responsabile del difetto, chiedendo i 3.850 euro di ripristino e il danno da godimento limitato. È l'informazione che di solito non gli viene data, mentre il soffitto peggiora e i termini corrono." },
    { type: "note", text: "L'errore da non fare: rinviare la denuncia all'impresa \"in attesa della prossima assemblea\". Il termine di un anno dalla scoperta ex art. 1669 c.c. corre comunque, e un'assemblea rinviata due volte può bruciare la garanzia decennale. Lo scenario descritto è un caso illustrativo: l'esito concreto dipende dalle risultanze tecniche e dai documenti del caso specifico." },

    { type: "timeline", title: "Due domande diverse, due risposte diverse", steps: [
      { when: "Comparsa delle macchie", label: "Documentare la data della scoperta", detail: "Sarà il primo argomento della difesa dell'impresa." },
      { when: "Chi deve pagare", label: "Riparto ex art. 1126 c.c.", detail: "Un terzo a chi ha l'uso esclusivo, due terzi ai condòmini coperti." },
      { when: "Se c'è un responsabile", label: "La regola cambia", detail: "Difetto di esecuzione del rifacimento: risponde l'impresa, non i condòmini." },
      { when: "1 anno dalla scoperta", label: "Denuncia ex art. 1669 c.c.", detail: "Copertura decennale: tre anni dal rifacimento non sono fuori termine." },
    ] },

    { type: "h2", text: "Domande frequenti", id: "faq" },
    { type: "faq", items: [
      { q: "Chi paga le infiltrazioni dal terrazzo: proprietario o condominio?", a: "Dipende dalla causa. Se derivano da vetustà o difetto di manutenzione, le spese si ripartiscono ex art. 1126 c.c.: un terzo a chi ha l'uso esclusivo, due terzi ai condòmini coperti dalla terrazza. Se derivano da un rifacimento eseguito male, risponde l'impresa e i condòmini non devono pagare: il condominio agisce contro di lei." },
      { q: "La ripartizione un terzo/due terzi vale sempre?", a: "No. È la regola di default per le spese di riparazione del lastrico o della terrazza a livello a uso esclusivo, e le Sezioni Unite 9449/2016 la estendono di regola al risarcimento da omessa manutenzione. Non si applica quando il danno ha un responsabile specifico — impresa, progettista — o quando il titolo di proprietà o il regolamento dispongono diversamente." },
      { q: "Ho appena rifatto la guaina: posso rifarmi sull'impresa?", a: "Sì, se la perdita dipende da difetti di esecuzione: raccordi non risvoltati, guaina non risalita sotto le soglie, giunti mal saldati. Le infiltrazioni da difetto di impermeabilizzazione sono gravi difetti ex art. 1669 c.c., con responsabilità decennale dal compimento dell'opera. Serve denunciare entro un anno dalla scoperta e agire entro l'anno successivo." },
      { q: "Quanto tempo ho per agire?", a: "Contro l'impresa: denuncia entro un anno dalla scoperta del difetto e azione entro un anno dalla denuncia, dentro i dieci anni dal compimento dell'opera (art. 1669 c.c.); per i vizi minori, denuncia in 60 giorni e prescrizione in due anni (art. 1667 c.c.). Il proprietario danneggiato ha cinque anni ex art. 2947 c.c. per il risarcimento." },
      { q: "Il proprietario sottostante deve aspettare la delibera dell'assemblea?", a: "No. Chi subisce il danno può agire direttamente contro il condominio quale custode della copertura ex art. 2051 c.c., contro il condòmino con uso esclusivo per la sua quota e contro l'impresa se il danno deriva dal rifacimento difettoso. L'attesa dell'assemblea non sospende nessun termine, mentre il danno al soffitto continua ad aggravarsi." },
      { q: "La garanzia di 15 anni del produttore della guaina mi copre?", a: "Solo in parte. Le garanzie convenzionali dei produttori coprono di norma il materiale — la membrana difettosa in sé — e non la posa in opera, che è la causa della grande maggioranza delle infiltrazioni. Per i difetti di posa il destinatario giusto resta l'impresa esecutrice, con i rimedi degli artt. 1667 e 1669 c.c." },
      { q: "Il condominio può agire contro l'impresa anche se ha pagato tutto il lavoro?", a: "Sì. Il pagamento integrale del corrispettivo e l'accettazione dell'opera non coprono i difetti non riconoscibili al momento della consegna, come una guaina mal raccordata che si manifesta solo dopo qualche stagione. L'amministratore è legittimato ad agire per la conservazione delle parti comuni, previa delibera per l'azione risarcitoria." },
    ] },

    { type: "h2", text: "Il passo successivo", id: "cta" },
    { type: "p", text: "Nelle infiltrazioni da terrazzo si sbaglia quasi sempre il destinatario della richiesta: si discute di millesimi mentre i termini verso l'impresa corrono. Aiutiamo a individuarlo prima di iniziare — con i documenti dell'appalto e una verifica tecnica mirata. Contattaci dalla pagina contatti con la data del rifacimento e le prime foto del danno: ti diciamo chi è il soggetto giusto e quali termini sono ancora aperti. Per il quadro generale leggi la guida ai difetti costruttivi e alla garanzia decennale; se il problema riguarda un cappotto termico che si stacca o non isola, c'è la guida dedicata." },
