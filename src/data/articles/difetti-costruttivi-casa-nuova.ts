...
export const article: Article = {
  ...
  content: [
    ...
    { type: "h2", text: "Il costruttore ha chiuso la società: [la polizza decennale postuma](/guide/polizza-decennale-postuma)", id: "polizza-postuma" },
