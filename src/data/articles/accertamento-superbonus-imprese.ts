...
export const article: Article = {
  ...
  content: [
    ...
    { type: "figure", slot: "accertamento-superbonus-imprese-1", alt: "Ponteggio su un condominio con cappotto termico in lavorazione", caption: "La difesa parte dalla prova che i lavori sono stati realmente eseguiti e documentati." },
    ...
    { type: "figure", slot: "accertamento-superbonus-imprese-2", alt: "Atto di recupero dell'Agenzia delle Entrate con la data di notifica in evidenza", caption: "Dalla notifica decorrono i termini per il ricorso: aspettare la cartella significa perdere il merito." },
    ...
    { type: "timeline", title: "I termini dell'accertamento", steps: [
      { when: "Notifica dell'atto", label: "Da qui decorre tutto", detail: "È il momento da cui si contano i giorni per impugnare." },
      { when: "60 giorni", label: "Termine per il ricorso", detail: "Perso il termine, si perde ogni difesa nel merito anche avendo ragione." },
      { when: "Contestualmente", label: "Istanza di sospensione della riscossione", detail: "Evita che l'esecuzione strangoli la cassa mentre il ricorso pende." },
      { when: "Subito", label: "Denuncia del sinistro alla polizza dell'asseveratore", detail: "I termini di polizza corrono in parallelo e scadono in silenzio." },
    ] },
